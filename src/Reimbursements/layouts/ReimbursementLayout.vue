...
import { ref } from 'vue'
const title = ref<string>('Devoluciones')
</script>
<template>
  <admin-layout>
    <div class="grid grid-cols-12 gap-4 md:gap-6">
      <div class="col-span-12">
        <Breadcrumbs
          :parent-path="{ name: 'Compras', root: '/reimbursements' }"
          :current-path="{ name: title, root: '/reimbursements' }"
        />
        <PageHeader group="Compras" :title="title" :count="0">
          <template #actions>
            <button
              type="button"
